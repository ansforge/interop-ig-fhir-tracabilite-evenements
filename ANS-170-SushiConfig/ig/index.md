...
| Draft as of 2026-01-23 | *Computable Name*:TDE |
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-01-23T15:23:05+00:00",
  ...
  "definition" : {
    ...
    "resource" : [
      ...
      },
      {
        ...
        "exampleCanonical" : "https://interop.esante.gouv.fr/ig/fhir/tde/StructureDefinition/fr-patient"
      },
      {
        "extension" : [
          {
      ...
      "page" : [
        ...
        },
        {
          "extension" : [
            {
              "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
              "valueUrl" : "specifications_technique_intro.html"
            }
          ],
          "nameUrl" : "specifications_technique_intro.html",
          ...
          "page" : [
            {
              "extension" : [
                {
                  "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
                  "valueUrl" : "specifications_technique_correspondance_metier.html"
                }
              ],
              "nameUrl" : "specifications_technique_correspondance_metier.html",
            ...
            },
            {
              "extension" : [
                {
                  "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
                  "valueUrl" : "specifications_technique_api.html"
                }
              ],
              "nameUrl" : "specifications_technique_api.html",
              "title" : "Via API REST",
              "generation" : "markdown"
            },
            {
              "extension" : [
                {
                  "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
                  "valueUrl" : "specifications_technique_syslog.html"
                }
              ],
              "nameUrl" : "specifications_technique_syslog.html",
              "title" : "Via syslog",
              "generation" : "markdown"
            }
          ]
          ...
          "page" : [
            ...
            },
            {
              "extension" : [
                {
                  "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
                  "valueUrl" : "normes_standards.html"
                }
              ],
              "nameUrl" : "normes_standards.html",
              "title" : "Etude norme et standards",
              "generation" : "markdown"
            },
            {
              "extension" : [
                {
                  "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
                  "valueUrl" : "annexe_audit_dicom.html"
                }
              ],
              "nameUrl" : "annexe_audit_dicom.html",
              "title" : "Mise en correspondance AuditEvent / DICOM",
              "generation" : "markdown"
            },
            {
              "extension" : [

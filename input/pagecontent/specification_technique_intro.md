...
[DICOM](http://dicom.nema.org/dicom/2013/output/chtml/part15/sect_A.5.html).
...
Transport](http://esante.gouv.fr/services/referentiels/ci-sis/espace-publication/couche-transport) du Cadre d’Interopérabilité des systèmes d’information de
santé (CI-SIS).

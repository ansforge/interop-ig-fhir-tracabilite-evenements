...
<caption><p>Mise en correspondance entre l'objet Trace et le schema AuditMessage de DICOM</p></caption>
<colgroup>
<col style="width: 21%" />
<col style="width: 26%" />
<col style="width: 23%" />
...
<td style="text-align: center;"><strong>Elément du schéma AuditMessage</strong></td>
...
<td rowspan="2" style="text-align: left;">ParticipantObjectIdentification</td>

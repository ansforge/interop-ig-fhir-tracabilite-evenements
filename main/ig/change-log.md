# Historique des versions - ANS - Traçabilité des événements v2.0.0
...
**Release 2.0.0 de l'Implementation Guide FHIR Traçabilité des événements.**

URL : [https://interop.esante.gouv.fr/ig/fhir/tde/2.0.0](https://interop.esante.gouv.fr/ig/fhir/tde/2.0.0)

[Modifications apportées dans cette release](https://github.com/ansforge/interop-ig-fhir-tracabilite-evenements/milestone/1?closed=1) :

* Mise en place de la structure de l'IG [#8](https://github.com/ansforge/interop-ig-fhir-tracabilite-evenements/pull/8)
* Ajout des normes et standard [#12](https://github.com/ansforge/interop-ig-fhir-tracabilite-evenements/pull/12)
* Ajout des spécifications fonctionnelles [#11](https://github.com/ansforge/interop-ig-fhir-tracabilite-evenements/pull/11)
* Ajout des ressources de conformité [#10](https://github.com/ansforge/interop-ig-fhir-tracabilite-evenements/pull/10)
* Ajout spécification technique [#9](https://github.com/ansforge/interop-ig-fhir-tracabilite-evenements/pull/9)

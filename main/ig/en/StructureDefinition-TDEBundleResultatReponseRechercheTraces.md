...
* Examples for this Profile: [Bundle/TDEBundleResultatReponseRechercheTracesExample](Bundle-TDEBundleResultatReponseRechercheTracesExample.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.tde|current/StructureDefinition/StructureDefinition-TDEBundleResultatReponseRechercheTraces.json)

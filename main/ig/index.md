# Accueil - ANS - Traçabilité des événements v2.0.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/tde/ImplementationGuide/ans.fhir.fr.tde | *Version*:2.0.0-ballot |
| Draft as of 2026-03-13 | *Computable Name*:TDE |
...
* [Audit Event ID](http://terminology.hl7.org/7.1.0/CodeSystem-audit-event-type.html): [AuditEvent/TDEAuditEventExample](AuditEvent-TDEAuditEventExample.md) and [Bundle/TDEBundleResultatReponseRechercheTracesExample](Bundle-TDEBundleResultatReponseRechercheTracesExample.md)

...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:AuditEvent">
      <sch:assert test="count(f:subtype) &lt;= 1">subtype: maximum cardinality of 'subtype' is 1</sch:assert>
      <sch:assert test="count(f:agent) &lt;= 2">agent: maximum cardinality of 'agent' is 2</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:AuditEvent/f:period</sch:title>
